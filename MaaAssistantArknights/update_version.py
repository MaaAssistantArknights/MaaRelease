...
MIRRORS = [
    ...
    ("github.com/MaaAssistantArknights/MaaRelease/releases/download", "ota2.maa.plus"),
    ("github.com/MaaAssistantArknights/MaaAssistantArknights/releases/download", "ota2.maa.plus"),
]
