...
~~Due to the changes in the infrastructure part of "Arknights" in version 2.4.41 updated on 2025/01/22, MAA is temporarily unable to handle the new version of infrastructure. We are working hard to fix it~~
...
The format of the resource version number is `Current Activity Name/Card Pool Name` + `#Update Date`. Since activities are usually divided into two halves, the minimum requirement for the version number should at least match the date of the level update.
