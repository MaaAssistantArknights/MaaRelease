...
已在 5.26.0-beta.1 公测版中支持。入口在 小工具-小游戏 中，需手动通过教程后在选关界面最左侧开始。

**战斗相关功能刚需模拟器 60 帧，别再开着动态帧率或者后台自动降帧说为什么跑不了了**  
**触控模式里的 adb input 只是兼容模式，只能满足基础功能，你问为什么部署不上去那我还要问问你为什么还在用这玩意呢**
