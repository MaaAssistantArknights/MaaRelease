...
**游戏内公招 UI 已更改**，正式版 5.26.1 以下版本无法正常使用，如有需要请尽快更新以恢复公招功能。
...
已在公测版 5.26.0-beta.1 中支持。入口在 小工具-小游戏 中，需手动通过教程后在选关界面最左侧开始。

`RM-TR-1` 和 `RM-1 (正式版 5.26.1 中添加)` 可使用 MAA 自动刷取资源。`RM-1` 支持更高资源产出，但需解锁前置要求，具体请参考对应功能页说明。活动即将结束，建议尽快刷取足够启动材料并推进关卡。
