### 11 月 23 日作业站服务器停机维护 (NEW!!!)

为进行数据库迁移，作业站将于 11 月 23 日（周日）9:00 ~ 13:00 进行停机维护。  
维护期间将无法进行作业的下载与上传。建议各位用户避开此时段使用作业功能。给各位用户带来的不便，我们深表歉意！还请各位用户相互转告。

----

### OS-S 关卡不支持战斗列表功能 (NEW!!!)

由于 OS-S 系列关卡的字体 OCR 容易误判，在目前版本中无法稳定使用战斗列表。  
反正就 5 关，懒得适配了
...
**卫戍协议：盟约**  
适配版本：v5.28.0-beta.1 及以上

· 手动通关 ｢标准模拟｣ 后会进入 ｢险境模拟｣ 进行刷分，得分效率更高  
· 只能刷等级奖励，拿蚀刻章需要完成全部的 ｢关键目标｣  
· 功能仅在测试通道提供，正式版将在 v5.28.0 合入  

**OS-喀兰贸易技术研发部**  
适配版本：v5.27.2 及以上

· 会重复尝试直到通关  
· 有时候没点卡牌右下角就有资源收集按钮了，这玩意是游戏的 bug，有人遇到了但我挂了几个小时都没遇到过一次，懒得修了
